...
const sif_arch_armv6s_m_word_t SIF_ARCH_ARMV6_M_KERNEL_PRIORITY
	= SIF_CONFIG_KERNEL_PRIORITY;
const sif_arch_armv6s_m_word_t SIF_ARCH_ARMV6_M_SYSTEM_CLOCK_HZ
	= SIF_CONFIG_SYSTEM_CLOCK_HZ;
const sif_arch_armv6s_m_word_t SIF_ARCH_ARMV6_M_SYSTICK_HZ
	= SIF_CONFIG_SYSTICK_HZ;

const sif_arch_armv6s_m_word_t SIF_ARCH_ARMV6_M_SYST_RVR_RELOAD
